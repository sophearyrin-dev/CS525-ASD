...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println("-------- All customers sorted with age --------");
		...
		System.out.println("-------- Customers with city = Chicago --------");

		Iterator<Customer> filterIteratorChicago = customerCollection.filterIterator(customer -> customer.getAddress().getCity().equalsIgnoreCase("CHICAGO"));
		while (filterIteratorChicago.hasNext()){
			System.out.println(filterIteratorChicago.next());
		}

		System.out.println("-------- Customer with address zip starts with 12 --------");

		Iterator<Customer> filterIteratorZipStartWith12 = customerCollection.filterIterator(customer -> customer.getAddress().getZip().startsWith("12"));
		while (filterIteratorZipStartWith12.hasNext()){
			System.out.println(filterIteratorZipStartWith12.next());
		}

		System.out.println("-------- Alternate Customers --------");

		Iterator<Customer> alternativeIterator = customerCollection.alternativeIterator();
		while (alternativeIterator.hasNext()){
			System.out.println(alternativeIterator.next());
		}
	}
}
